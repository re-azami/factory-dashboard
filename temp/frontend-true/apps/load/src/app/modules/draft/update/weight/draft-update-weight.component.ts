...
@Component({
    selector: 'draft-update-weight',
    templateUrl: './draft-update-weight.component.html',
    styleUrl: './draft-update-weight.component.scss',
    standalone: false
})
export class DraftUpdateWeightComponent implements OnInit {
