...
import {
    ApiService,
    ILaboratoryMiscCreateRq,
    ILaboratoryMiscCreateRs,
...
export class MiscCreateComponent {
        ...
        sections: [
            {
                columns: [
                    ...
                    { inputs: [{ name: 'date', type: 'DATE', value: new Date(), maxDate: new Date() }] },
                ],
            },
    ...
    ngxSubmit(values: INgxFormValues): void {
        ...
        const body: ILaboratoryMiscCreateRq = {
            date: values['date'],
            title: values['title'],
        ...
        this.apiService.request<ILaboratoryMiscCreateRs>('LaboratoryMiscCreate', { body }, () => {
