...
@Component({
    host: { selector: 'production-crusher-create' },
    standalone: false,
    templateUrl: './production-crusher-create.component.html',
    styleUrl: './production-crusher-create.component.scss',
})
export class ProductionCrusherCreateComponent {
    ...
    public ngxForm: INgxForm = {
        ...
        inputs: [
            ...
            [
                { name: 'gauss1200', type: 'NUMBER', title: 'تناژ گاوس ۱۲۰۰', optional: true, minimum: 1, suffix: 'تن' },
                { name: 'gauss2000', type: 'NUMBER', title: 'تناژ گاوس ۲۰۰۰', optional: true, minimum: 1, suffix: 'تن' },
                { name: 'tail', type: 'NUMBER', title: 'تناژ باطله', optional: true, minimum: 1, suffix: 'تن' },
            ],
            {
                name: 'description',
                type: 'TEXTAREA',
