...
import { ProductionKhatkaCreateComponent } from './create/production-khatka-create.component';
import { ProductionKhatkaUpdateComponent } from './update/production-khatka-update.component';

@Component({
    host: { selector: 'production-khatka' },
    standalone: false,
    templateUrl: './production-khatka.component.html',
    styleUrl: './production-khatka.component.scss',
})
export class ProductionKhatkaComponent {
        ...
        columns: [
            {
                ...
                type: 'DATE',
                action: (data) => ['/production', 'khatka', data.id],
            },
        ...
        actions: [
            {
                title: 'مشاهده نتایج',
                icon: 'biotech',
                action: (data: ILaboratoryKhatkaDTO) => ['/production', 'khatka', data.id],
            },
            'DIVIDER',
