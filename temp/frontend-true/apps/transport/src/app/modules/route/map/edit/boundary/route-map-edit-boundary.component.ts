...
@Component({
    host: { selector: 'route-map-edit-boundary' },
    templateUrl: './route-map-edit-boundary.component.html',
    styleUrl: './route-map-edit-boundary.component.scss',
    standalone: false
})
export class RouteMapEditBoundaryComponent {
